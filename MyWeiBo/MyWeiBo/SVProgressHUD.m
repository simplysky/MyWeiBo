...
#define TIME_INTERVAL_DURATION 2.0 //add by machunyan (改变浮层的显示时间)
...
//    NSTimeInterval displayInterval = [[self sharedView] displayDurationForString:string];
    [[self sharedView] showImage:image status:string duration:TIME_INTERVAL_DURATION maskType:maskType];
}
